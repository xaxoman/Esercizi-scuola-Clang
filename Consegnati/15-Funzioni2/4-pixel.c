...
- un main che chiede all’utente di inserire i valori delle tre componenti di un pixel e stampi sullo schermo il 
valore della luminosità media se è possibile calcolarla, altrimenti un opportuno messaggio di errore.
